...
if(playgame){
    submit.addEventListener("click",function(e){
        ...
        valiodateGuess(guess)
    })
}


function valiodateGuess(guess){
    if(isNaN(guess) ){
...
function displayGuess(guess){
    userInput.value = ''
    guessesSlot.innerHTML += `${guess} , ` // value push in array
    numGuess ++;
...
function endGame(){
  userInput.value = ''
  userInput.setAttribute('disabled', ' ') //setatt are all ways key valu pair so '', ''
